...
import type { ThemeMode } from "@/shared/lib/theme-cookie-names";
 ...
 */
export function LandingPage({ initialTheme }: { initialTheme: ThemeMode | null }) {
  return (
    <>
      <div className="landing-hero">
        <SiteHeader initialTheme={initialTheme} variant="overlay" />
